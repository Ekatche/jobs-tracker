        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-10 leading-relaxed">
              Une application simple qui vous permet de centraliser et suivre
              toutes vos candidatures envoyées à différentes entreprises via
              différents sites d'emploi.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-blue-night p-8 rounded-xl shadow-md hover:shadow-lg transition-shadow border border-gray-800">
              ...
              <p className="text-gray-300 leading-relaxed">
                Regroupez toutes vos candidatures au même endroit, quelle que
                soit la plateforme d'emploi utilisée.
              </p>
            </div>
            <div className="bg-blue-night p-8 rounded-xl shadow-md hover:shadow-lg transition-shadow border border-gray-800">
              <div className="bg-blue-900/30 w-12 h-12 flex items-center justify-center rounded-full mb-4">
              ...
              <p className="text-gray-300 leading-relaxed">
                Triez et filtrez vos candidatures par statut, entreprise ou date
            ...
            <div className="bg-blue-night p-8 rounded-xl shadow-md hover:shadow-lg transition-shadow border border-gray-800">
              ...
              <p className="text-gray-300 leading-relaxed">
                Suivez l'évolution de chaque candidature et ne manquez plus
                aucun retour ou entretien.
              </p>
            </div>
          </div>
        </div>
